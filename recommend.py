...
def group_by_centroid(restaurants, centroids):
    ...
    # BEGIN Question 4
    "*** YOUR CODE HERE ***"
    restaurant_centroid_pairs=[[find_closest(restaurant_location(x), centroids), x] for x in restaurants]
...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    "*** YOUR CODE HERE ***"
    predictor_pairs=dict([[find_predictor(user, reviewed, x)[0],find_predictor(user, reviewed, x)[1]] for x in feature_fns])
    return max(predictor_pairs, key=predictor_pairs.get)
    # END Question 8
...
def rate_all(user, restaurants, feature_fns):
    ...
    # BEGIN Question 9
    "*** YOUR CODE HERE ***"
    all_ratings={restaurant_name(x): user_rating(user, restaurant_name(x)) if x in reviewed else predictor(x) for x in restaurants} 
    return all_ratings
    # END Question 9
